...
const customer_plate_detail = JSON.parse(localStorage.getItem("customer_plate_detail")) || []
const AddCard = () => {
    const [localData, setLocalData] = useState(getLocalData);
    const [quantityCount, setQuantity] = useState(localData.length > 0 ? getLocalData[0].quantity : 1)
    ...
    const handleRedirectToPlaceOrderPage = () =>{
                        ...
                        <Box borderRadius={2} h={"300px"} bg={"#fff"} boxShadow={"rgba(99, 99, 99, 0.2) 0px 2px 8px 0px"} width="250px">
                            <VStack>
                                ...
                                <Box>
                                    ...
                                    borderRadius={2}
                                    width={220}
                                    onClick={handleRedirectToPlaceOrderPage}
